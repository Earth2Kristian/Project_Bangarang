...
public class HitColliderForMPScript : MonoBehaviour
{
    ...
    private float knockbackForce = 13;
    private float strongKnockbackForce = 17;
    private float weakKnockbackForce = 9;
    ...
    void Start()
    {
        attackDamage = Random.Range(9, 16);
    }
